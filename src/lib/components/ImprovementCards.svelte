        ...
        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
          <div class="flex items-start justify-between mb-3">
            <div class="flex items-center space-x-2">
              ...
              <span class="px-2 py-1 text-xs font-medium border rounded-full {getScoreBadge(improvement.score)}">
          ...
          {#if improvement.displayValue}
            <div class="text-sm font-medium {getScoreColor(improvement.score)}">
          ...
          <details class="mt-3">
            ...
            <div class="mt-2 text-xs text-gray-600">
              {#if improvement.details}
                <pre class="whitespace-pre-wrap bg-gray-50 p-2 rounded text-xs overflow-x-auto">
